...
$x$ = number of torte  
$y$ = number of apple pie   

Our object is to maximize $4*x+5*y$ with coinstraint $2*x+3*y \le 60$.  
We can solve it using the graphical method as below.  
...
plot(x, y, type="l", xlim = c(-5,40), ylim=c(-5,30), axes = FALSE, 
     xlab = "No. of torte", ylab = "No. of apple pie")
axis(1, pos=0); axis(2, pos=0)
polygon(x = c(0,0,30), y = c(0,20,0), col = "grey")

abline(a=0, b=-4/5, col = "red")
text(x=0, y = -2, labels = "4x+5y=0", col = "blue",pos=4)
points(x=0, y=0, col="red", pch=19)

abline(a=20, b=-4/5, col = 'red')
text(x=0, y = 20, labels = "4x+5y=100", col = "blue",pos=4)
points(x=0, y=20, col="red", pch=19)

abline(a=24, b=-4/5, col = "red")
text(x=30, y = 2, labels = "4x+5y=120", col = "blue",pos=4)
points(x=30, y=0, col="red", pch=19)
text(x=30, y = -2, labels = "(30,0)")

```

In this case, Max can get 120 points when he eat 30 torte.  

On the other hand, if there is an additional constraint that number of pies is at least as many as torte($y \ge x$), the graph is chaged like below.
...
plot(x, y, type="l", xlim = c(-5,40), ylim=c(-5,30), axes = FALSE, 
     xlab = "No. of torte", ylab = "No. of apple pie")
axis(1, pos=0); axis(2, pos=0)
polygon(x = c(0,0,12), y = c(0,20,12), col = "grey")
...
abline(a=21.6, b=-4/5, col = "red")
points(x=12, y=12, col="red", pch=19)
text(x=13, y = 12, labels = "4x+5y=108", col = "blue",pos=4)
text(x=12, y = 10, labels = "(12,12)")

```

In this case, he can get 108 points and there is 12 points decrease because of additional constraint.
...
a. Let x = size of arc with wheat and y = size of arc with corn. And the constraints are below :
* $x + y \le 450$
* $3x + 2y \le 1000$
* $2x + 4y \le 1200$

Then we can solve the problem graphically.
...
plot(x, y, type="l", xlim = c(-5,500), ylim=c(-5,500), axes = FALSE, 
     xlab = "Size of wheat", ylab = "Size of corn")
axis(1, pos=0); axis(2, pos=0)
polygon(x = c(0,0,200,1000/3), y = c(0,300,200,0), col="grey")
abline(a=450, b =-1)
abline(a=300, b=-1/2)

abline(a=0, b=-2/3, col="red")
points(x=0, y=0, col="red", pch=19)
text(x=0, y = 20, labels = "2000x+3000y=0", col = "blue",pos=4)

abline(a=300, b=-2/3, col="red")
points(x=0, y=300, col="red", pch=19)
text(x=0, y = 320, labels = "2000x+3000y=900000", col = "blue",pos=4)

abline(a=1000/3, b=-2/3, col="red")
points(x=200, y=200, col="red", pch=19)
text(x=200, y = 220, labels = "2000x+3000y=1000000", col = "blue",pos=4)
text(x=200, y = 170, labels ="(200, 200)")
```

So, the solution of this problem using graphic is this : 200 acres with wheat, 200 acres with corn and we can get \$1,000,000 profit.  

###

b. We can solve the problem in R as below
...
As a result, we can get this solution : 200 acres of wheat, 200 acres of corn and $1,000,000 profit. This solution is same with the solution using graphic.

###

c. The results of dynamic fertilizer is below:
...
In this solution, the farmer discontinue wheat when fertilizer is equal or greater than 1800 and stop producing corn until wheat is 600 without integer condition or without integer condition.
...
As a result, we should buy 2 corns, 10 milk, 10 wheat bread to minimize cost.
...
Variables  
* $x_{i}$ : amount of wood for harvesting of unit 1 in year $i$  
* $y_{i}$ : amount of wood for harvesting of unit 2 in year $i$  
